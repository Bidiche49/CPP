...
/*   Updated: 2024/03/22 18:10:52 by ntardy           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
std::string wichLit(std::string entry) {
	if (!entry.compare("-inf") || !entry.compare("-inff")) {
		return ("-inf");
	} else if (!entry.compare("+inf") || !entry.compare("+inff")) {
		return ("+inf");
	} else if (!entry.compare("nan") || !entry.compare("nanf")) {
		return ("nan");
	} else {
		return "";
	}
