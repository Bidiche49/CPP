...
/*   Updated: 2023/10/27 17:17:19 by ntardy           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::~ClapTrap() {
	std::cout << "ClapTrap destuctor called. Ciao " << this->getName() << std::endl;
}

ClapTrap::ClapTrap ( const ClapTrap& cpy ) {
	std::cout << "ClapTrap constructor called. Hello " << cpy.getName() << "'s twins" << std::endl;
	*this = cpy;
}
